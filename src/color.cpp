...
const short default_set[MAX_COLORS] = {
   ...
   AT_RED + AT_BLINK, AT_GREY, AT_GREY, AT_CYAN,   /* 19 */
   AT_LBLUE, AT_LBLUE, AT_BLUE, AT_WHITE, /* 23 */
   AT_YELLOW, AT_WHITE, AT_RED, AT_WHITE,  /* 27 */
   AT_RED + AT_BLINK, AT_BLUE, AT_WHITE, AT_GREY, /* 31 */
   AT_GREEN, AT_DGREY, AT_BLOOD, AT_RED,  /* 35 */
   AT_GREEN, AT_BLOOD, AT_GREY, AT_YELLOW, /* 39 */
   AT_LBLUE, AT_DGREY, AT_GREEN, AT_PINK,  /* 43 */
   AT_GREY, AT_GREEN, AT_YELLOW, AT_BLUE,  /* 47 */
   AT_GREY, AT_ORANGE, AT_BLUE, AT_RED,   /* 51 */
   AT_WHITE, AT_YELLOW, AT_WHITE, AT_LBLUE, /* 55 */
   AT_DGREEN, AT_PURPLE, AT_WHITE, AT_RED, /* 59 */
   AT_GREY, AT_DGREEN, AT_RED, AT_BLUE,   /* 63 */
   AT_WHITE, AT_CYAN, AT_WHITE, AT_DGREY,   /* 67 */
   ...
   AT_GREEN, AT_GREEN, AT_GREEN, AT_LBLUE,   /* 95 */
   AT_BLOOD
};
...
void show_colors( CHAR_DATA *ch )
{
    ...
    send_to_pager( "&BSyntax: color _all_ [color] (Sets all color types to [color])\r\r\n\n", ch );
    send_to_pager( "&BSyntax: color theme [name] (Sets all color types to a defined theme)\r\r\n\n", ch );
